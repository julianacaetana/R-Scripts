...
library(stringr)
library(reshape2)
Sys.setenv(JAVA_HOME='C:/Program Files (x86)/Java/jre1.8.0_181') ##Tratando erro do java não encontrado
library(xlsx)
```
...
lista.dataset <-
  datasets[, 1:17]  ##dataset com informações gerais dos datasets

write.xlsx(
  lista.dataset,
  "D:/Pós Graduação/Projeto Aplicado/Scraping/datasets.xlsx",
  sheetName = "Lista De Datasets",
  col.names = TRUE,
  row.names = F,
  append = F,
  showNA = F,
...
lista.links$variable <-
  str_remove(lista.links$variable, ".[0-9]+") ##padroniza as variáveis
lista.links <- reshape(
  lista.links,
  timevar = "variable"
  ,
